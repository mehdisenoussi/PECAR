function pecar_p1p2_bootstrap(subj_pA, subj_pB, repeatnumber,validity, probeGratPos)
    ...
    save(sprintf('/Volumes/PNY/PECAR/data/fft_p_%s_%svalid_11subjs.mat',probeGratPos,...
    ...
    save(sprintf('/Volumes/PNY/PECAR/data/fft_ALL_p_%s_%svalid_11subjs.mat',probeGratPos,...
        txtval), sprintf('fft_p_%svalid',txtval)) 
end