function pecar_p1p2_bootstrap(pecar_loc, subj_pA, subj_pB, repeatnumber,validity, probeGratPos)
    ...
    save([pecar_loc 'pecar_data/' sprintf('fft_p_%s_%svalid_11subjs.mat',probeGratPos,...
    ...
    save([pecar_loc 'pecar_data/' sprintf( 'fft_ALL_p_%s_%svalid_11subjs.mat',probeGratPos,...
        txtval)], sprintf('fft_p_%svalid',txtval)) 
end